...
type Page = 'dashboard' | 'tracks' | 'modules' | 'tips' | 'quiz' | 'checklist' | 'videoaulas' | 'report';
...
const menuItems: { id: Page; label: string; icon: string; color: string }[] = [
  ...
  { id: 'report', label: 'Relatório', icon: '📈', color: 'hover:bg-teal-50' },
];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 bg-gradient-to-r from-yellow-500 to-amber-500">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-100">Treinamento & Dicas</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 space-y-3 border-t border-gray-100">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl p-4">
              <p className="text-xs font-semibold text-amber-800 mb-1">⚠️ Lembre-se</p>
